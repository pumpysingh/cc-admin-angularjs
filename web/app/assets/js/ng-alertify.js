    ...
    Alertify = function () {
        ...
        dialogs = {
            buttons : {
                ...
                submit : "<button type=\"submit\" class=\"btn btn-default\" id=\"alertify-ok\">{{ok}}</button>",
                ok     : "<a href='#'  class=\"btn  btn-primary popbtn \" id=\"alertify-ok\" style='padding:7px 10px; margin-right: 5px;'>{{ok}}</a>",
                cancel : "<a href='#'  class=\"btn  btn-default  popbtn\" id=\"alertify-cancel\" style='padding:7px 10px;'>{{cancel}}</a>"
            },
